...
namespace ASTBuilder
{
	...
	public abstract class AbstractNode : IVisitableNode
	{
	    ...
	    private Type type;
        private Attributes attributesRef;
        private TypeDescriptor typeRef;
        public AbstractNode()
	   {
		  parent = null;
		  mysib = null;
	   ...
	   public virtual Type NodeType
	   {
        ...
        public virtual Attributes AttributesRef
        {
            get
            {
            ...
            set
            {
                this.attributesRef = value;
            }
        }
        public virtual TypeDescriptor TypeRef
        {
            get
            {
                return typeRef;
        ...
        public virtual void Accept(IReflectiveVisitor v)
	   {
        ...
        {
            return (AbstractNode)MemberwiseClone();
        }
    }
