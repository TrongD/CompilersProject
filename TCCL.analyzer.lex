...
<INITIAL> {
{Identifier}                   { yylval = new Identifier(yytext); return (int)Token.IDENTIFIER;  /* parser acccesses name from yytext */}
 
{DecIntegerLiteral}            { yylval = new ConstantValue(yytext); return (int)Token.INT_NUMBER; /* parser must convert yytext to an integer */}
